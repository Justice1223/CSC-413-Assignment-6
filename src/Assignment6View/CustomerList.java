...
public class CustomerList extends javax.swing.JFrame {
	...
	private JList<String> custList1;
    private Map<String, Integer> customerIdMap;
    private JButton showAccountsButton;
    private CustomerDetail customerDetailFrame;
    private AccountList bankAccountListFrame;
    /**
    ...
    private void initComponents() {
        ...
        custList1 = new javax.swing.JList<>();
        ...
        custList1.setModel(new javax.swing.AbstractListModel<String>() {
            String[] strings = { "Item 1", "Item 2", "Item 3", "Item 4", "Item 5" };
            public int getSize() { return strings.length; }
            public String getElementAt(int i) { return strings[i]; }
        });
        jScrollPane1.setViewportView(custList1);
    ...
    private void populateCustomerList(List<BankCustomer> customers) {
        DefaultListModel<String> listModel = new DefaultListModel<>();
        customerIdMap = new HashMap<>();
        for (BankCustomer customer : customers) {
            String displayName = customer.getName();
            listModel.addElement(displayName);
            customerIdMap.put(displayName, customer.getCustomerNumber());
        }
        custList.setModel(listModel);
    }
    ...
    public JButton getShowAccountsButton() {
        return showAccountsButton;
    }

    public CustomerDetail getCustomerDetailFrame() {
        return customerDetailFrame;
    }

    public AccountList getBankAccountListFrame() {
        return bankAccountListFrame;
    }

    private BankCustomer getSelectedCustomer() {
        return new BankCustomer(); // Placeholder
    }
}
